...
export const translations = {
  en: {
    ...
    appSubName: 'Agent-Audited Compute Outsourcing',
    navDefine: 'Define New Task',
    navMarket: 'Task Marketplace',
    navRegistry: 'Transaction Registry',
    navNavRegistry: 'Transaction Registry',
    navDefineNewTask: 'Define Task Parameters',
    navMarketplace: 'Computation Task Marketplace',
    sandboxActive: 'SANDBOX MODE ACTIVE',
    devHost: 'Developer Host Gateway',
    heroTitle: 'Deconstruct & Delegate Intelligent Tasks',
    heroSub: 'Input raw queries. Our specialized spec agent will structure rigid validation rubrics and programmatically lock MetaMask Wallet escrows.',
    marketSub: 'Browse dynamic computational tasks secured with active MetaMask wallet deposit smart escrow controls.',
    escrowAddress: 'MetaMask Escrow Address',
    devFunds: 'Developer Sandbox Balance',
    pactGates: 'MetaMask Pact Gates ({count})',
    allPactsApproved: 'All MetaMask Pacts Approved',
    readyNewOrders: 'Ready to sync new task parameters on-chain',
    pactBtnApprove: 'Approve MetaMask Pact',
    pactBtnReject: 'Reject',
    pactRequireDeposit: 'Deposit Amount Required:',
    pactRuleLabel: 'MetaMask Pact Rule:',
    pactRuleDesc: 'Allow Compute Payout Only',
    arbitrumNova: 'Arbitrum Nova Testnet',
    version: 'z.ai v1.0.0 (Beta)',
    pendingPacts: '{count} Pending MetaMask Pacts',
    ...
    agentCompileText: 'Excellent choice. I compiled your request into a ready-to-sign Smart Contract Computation Order with budget deposit requirements. Review the Pact and sign to deploy the task on-chain:',
    orderSpecTitle: 'Computation Order Spec',
    orderDeposit: 'Deposit Balance:',
    ...
    btnDeployCoboPact: 'Deploy via MetaMask Pact',
    ...
    congratsMsg: '🎉 CONGRATULATIONS! MetaMask Wallet securely approved the deposit escrow. Computation Order #{id} is now active in the Task Marketplace.',
    ...
    coboEscrowBudget: 'Budget funded using MetaMask Escrow contract controls.',
    ...
    coboTimelineTitle: 'MetaMask Settlement Engine Status',
    ...
    coboStep4Desc: 'MetaMask Wallet escrow released tokens',
    coboEscrowReleased: 'MetaMask Escrow SafeReleased',
    ...
    // Common Alerts
    alertPactRequested: 'MetaMask Pact requested! Check your pending Pacts in the sidebar wallet widget to authorize budget escrow.',
    alertDeployed: 'Task successfully deployed! Order parameters written on-chain with ipfs hashes!',
    alertFunded: 'MetaMask Escrow release finalized! Tokens distributed according to audited score math parameters.',
    ...
    connectWalletBtn: 'Connect MetaMask Wallet',
    connectingWallet: 'Initiating MetaMask Wallet cryptographic session...',
    walletConnectedMsg: 'MetaMask Wallet authenticated successfully!',
    logoutBtn: 'Sign Out Account'
  },
  zh: {
    // Nav & Sidebar
    appName: 'z.ai 算力协同',
    appSubName: '智能代理网关协作与多签代发平台',
    navDefine: '创建新任务',
    navMarket: '任务算力市场',
    navRegistry: '全链活动记录',
    navNavRegistry: '全链活动记录',
    navDefineNewTask: '自主定义算力需求',
    navMarketplace: '算力供需大厅',
    sandboxActive: '沙盒环境已激活',
    devHost: '开发者直连网关',
    heroTitle: '智能解析与可信算力外包',
    heroSub: '只需输入您的具体自然语言技术愿景，即可通过专精的 Agent 结构化拟定核验标准，借助 MetaMask 智能托管代币预算解锁。',
    marketSub: '浏览当前在 Arbitrum Sandbox 中部署的、已注入且锁定了多签保证金的各个链上外包订单项目。',
    escrowAddress: 'MetaMask 代管地址',
    devFunds: '开发者钱包/代管池余额',
    pactGates: 'MetaMask Pact 签名流程 ({count})',
    allPactsApproved: '所有多端共签协议已被批准',
    readyNewOrders: '已同步锁定，系统可承接新的算力划拨命令',
    pactBtnApprove: '批准此代管提案',
    pactBtnReject: '拒绝并取消',
    pactRequireDeposit: '此划款共签要求存入:',
    pactRuleLabel: 'MetaMask Pact 契约规则:',
    pactRuleDesc: '仅清算核定分以上的部分',
    arbitrumNova: 'Arbitrum Nova 沙盒测试网通道',
    version: '平台版本 v1.0.0 (公测中)',
    pendingPacts: '{count} 项待鉴签 MetaMask Pact 会话',
    ...
    agentIntroText: '你好！我是 z.ai 验收机制设计 Agent。我已解析您的业务意图，并针对该特定用例自动定制了 2 套兼顾精度与预算成本的验证者验收法则：',
    checkingCheckmarks: '验证核对标准清单:',
    btnSelectRule: '选定并确认此验收规则组',
    btnRuleSelected: '此验收规则已被确认写入',
    userMessageChoose: '我已批准并选择验收基准：{name}',
    agentCompileText: '极佳的选择。我已经将您的计算要求编译为了支持智能合约部署的「计算订单」。请预览下方生成的 MetaMask Pact 安全策略并授权划转保证金：',
    ...
    btnDeployCoboPact: '批准划款并启动 MetaMask Pact',
    escrowFundedLive: '托管资金已锁定，计算任务订单正式推送至市场！',
    escrowPending: '正等待您在 MetaMask 钱包栏确认首笔 Pact 划款授权...',
    congratsMsg: '🎉 祝贺！MetaMask 钱包已批准预算锁定交易并签名。计算任务 #{id} 现已进入开放算力市场。',
    ...
    marketHeaderDesc: '浏览当前测试网络中在运行的、已足额锁定代币预算的所有分布式计算需求。',
    ...
    settledScore: '终评和解分',
    auditorReport: '审计评论：',
    coboEscrowBudget: '所有奖励和退款均通过 MetaMask 协议进行划转。',
    ...
    coboStep4: '托管资产释放结算',
    coboStep4Desc: 'MetaMask 钱包根据和解规则执行清算发钱',
    coboEscrowReleased: 'MetaMask 托管资金合规释放',
    coboTxId: '清算转账交易哈希:',
    ...
    // Common Alerts
    alertPactRequested: 'MetaMask 提案请求发起！请查阅侧边栏 MetaMask Pact 框批准锁定划款决策。',
    alertDeployed: '计算订单成功锚定并上链！核心验证哈希组已被系统固化密封。',
    alertFunded: 'MetaMask 托管资金合规分发完成。利益相关各方奖励金已按智能对账算法清算结转。',
    ...
    connectWalletBtn: '连接 MetaMask 钱包',
    connectingWallet: '正在初始化 MetaMask 钱包加密交互会话...',
    walletConnectedMsg: 'MetaMask 钱包关联鉴权成功！',
    logoutBtn: '注销/退出登录'
  }
};
